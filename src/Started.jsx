...
const Started = () => {
  return (
    <div className='my-30 bg-[#F9FAFC] py-30'>
        ...
        <div className='grid grid-cols-3 max-w-[80%] mx-auto gap-45'>
            {/* Card1  */}
            <div className='relative p-10 bg-white border border-gray-100 rounded-2xl shadow-sm text-center max-w-sm'>
